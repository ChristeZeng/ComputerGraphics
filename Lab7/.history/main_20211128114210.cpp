...
void GetInputKey(unsigned char key, int x, int y) {
    if(key == 'w') {
        float cosa = sqrt((eyex - centerx) * (eyex - centerx) + (eyez - centerz) * (eyez - centerz)) / (eyez - centerz);
        float sina = sqrt((eyex - centerx) * (eyex - centerx) + (eyez - centerz) * (eyez - centerz)) / (eyex - centerx);
        eyez -= 2 * cosa;
        eyez += 
    }
    else if(key == 's') {

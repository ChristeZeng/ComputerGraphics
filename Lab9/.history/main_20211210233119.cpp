...
void BindTexture(){
    ...
    TextureArray[5] = LoadTexture("skybox2/back.png");
    TextureArray[6] = LoadTexture("skybox2/front.png");
    TextureArray[7] = LoadTexture("skybox2/bottom.png");
    TextureArray[8] = LoadTexture("skybox2/top.png");
    TextureArray[9] = LoadTexture("skybox2/left.png");
    TextureArray[10] = LoadTexture("skybox2/right.png");

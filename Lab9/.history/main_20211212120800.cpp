...
void BindTexture(){
    ...
    TextureArray[5] = LoadTexture("skybox1/back.jpg");
    TextureArray[6] = LoadTexture("skybox1/front.jpg");
    TextureArray[7] = LoadTexture("skybox1/bottom.jpg");
    TextureArray[8] = LoadTexture("skybox1/top.jpg");
    TextureArray[9] = LoadTexture("skybox1/left.jpg");
    TextureArray[10] = LoadTexture("skybox1/right.jpg");

...
Texture TextureArray[TextureNum];
...
void BindTexture(){
    ...
    TextureArray[5] = LoadTexture("skybox2/back.jpg");
    TextureArray[6] = LoadTexture("skybox2/front.jpg");
    TextureArray[7] = LoadTexture("skybox2/bottom.jpg");
    TextureArray[8] = LoadTexture("skybox2/top.jpg");
    TextureArray[9] = LoadTexture("skybox2/left.jpg");
    TextureArray[10] = LoadTexture("skybox2/right.jpg");
...
void SkyBox(float x, float y, float z, float width, float height, float len) 
{
...
void Display() {
    ...
    SkyBox(-100 + eyex, -100 + eyey, -100 + eyez, 200.0f, 200.0f, 200.0f);
    DisplaySun();
    DisplayEarthAndMoon();
    DisplayMercury();
    DisplayMars();

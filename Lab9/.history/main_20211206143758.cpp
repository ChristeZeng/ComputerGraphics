...
void BindTexture(){
    ...
    TextureArray[5] = LoadTexture("nx.jpg");
    TextureArray[6] = LoadTexture("ny.jpg");
    TextureArray[7] = LoadTexture("nz.jpg");
    TextureArray[8] = LoadTexture("px.jpg");
    TextureArray[9] = LoadTexture("py.jpg");
    TextureArray[10] = LoadTexture("pz.jpg");

...
void BindTexture(){
    ...
    TextureArray[5] = LoadTexture("images/back.jpg");
    TextureArray[6] = LoadTexture("images/front.jpg");
    TextureArray[7] = LoadTexture("images/bottom.jpg");
    TextureArray[8] = LoadTexture("images/top.jpg");
    TextureArray[9] = LoadTexture("images/left.jpg");
    TextureArray[10] = LoadTexture("images/right.jpg");

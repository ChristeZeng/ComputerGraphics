...
{
	return (x > 400 || x < 0 || y > 300 || y < 0) ? false : true;
}

void MidBresenham(int x0, int y0, int a, int b, unsigned char data[])
{
	//确定第一个点的位置
	int x = 0;
	int y = b;

	data[(x + x0) * 400 * 3 + (y + y0) * 3] = 255;
	//初始误差

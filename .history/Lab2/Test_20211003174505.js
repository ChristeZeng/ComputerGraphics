...
function main()
{
    ...
    function draw()
    {
        ...
        drawRing(0, 0, 0, 100, vertices, black);

        drawRing(0.26, 0, 0, 100, vertices, red);

        drawRing(-0.13, -0.11, 0, 100, vertices, yellow);

        drawRing(0.13, -0.11, 0, 100, vertices, green);

        drawRing(-0.26, 0.0, 20, 30, vertices, blue);

        drawRing(0, 0, 50, 60, vertices, black);

        drawRing(0, 0, 20, 30, vertices, black);

        drawRing(0.26, 0, 50, 60, vertices, red);   
    }

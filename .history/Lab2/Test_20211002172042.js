...
function initBuffers(gl)
{
    ...
    {
        var theta = i * 2 * Math.PI / N;
        var x_inner = 0.1 + r_inner * Math.sin(theta);
        var y_inner = 0.1 + r_inner * Math.cos(theta);
        var x_outter = 0.1 + r_outter * Math.sin(theta);
        var y_outter = 0.1 + r_outter * Math.cos(theta);
        vertices.push(x_inner, y_inner);
        vertices.push(x_outter, y_outter);
    }

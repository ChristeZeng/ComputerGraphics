...
void earthmaterial() {
	...
	GLfloat earth_mat_emission[] = { 0.0f, 0.0f, 1.0f, 1.0f }; //定义材质的辐射光颜色
...
void moonmaterial() {
	...
	GLfloat earth_mat_specular[] = { 0.8f, 0.8f, 0.8f, 0.2f }; //定义材质的镜面反射光颜色
	GLfloat earth_mat_emission[] = { 1.0f, 1.0f, 1.0f, 1.0f }; //定义材质的辐射光颜色
	GLfloat earth_mat_shininess = 30.0f;
	glMaterialfv(GL_FRONT, GL_AMBIENT, earth_mat_ambient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, earth_mat_diffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, earth_mat_specular);
...
void mercurymaterial() {
	...
	GLfloat earth_mat_specular[] = { 0.8f, 0.8f, 0.8f, 0.2f }; //定义材质的镜面反射光颜色
	GLfloat earth_mat_emission[] = { 0.0f, 1.0f, 0.0f, 1.0f }; //定义材质的辐射光颜色
	GLfloat earth_mat_shininess = 30.0f;
	glMaterialfv(GL_FRONT, GL_AMBIENT, earth_mat_ambient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, earth_mat_diffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, earth_mat_specular);
...
void marsmaterial() {
	...
	GLfloat earth_mat_specular[] = { 0.8f, 0.8f, 0.8f, 0.2f }; //定义材质的镜面反射光颜色
	GLfloat earth_mat_emission[] = { 0.0f, 1.0f, 1.0f, 1.0f }; //定义材质的辐射光颜色
	GLfloat earth_mat_shininess = 30.0f;
	glMaterialfv(GL_FRONT, GL_AMBIENT, earth_mat_ambient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, earth_mat_diffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, earth_mat_specular);
